...
var deepStyle=[
  {background:'red',color:'black',height:'40px',marginBottom:'1px'},
  {background:'orange',color:'black',height:'40px',marginBottom:'1px'},
  {background:'yellow',color:'black',height:'40px',marginBottom:'1px'},
  {background:'green',color:'black',height:'40px',marginBottom:'1px'},
  {background:'blue',color:'black',height:'40px',marginBottom:'1px'}
];
